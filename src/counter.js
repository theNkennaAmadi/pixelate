...
class Content {
  ...
  constructor(DOM_el) {
    ...
    console.log(window.getComputedStyle(this.DOM.canvasWrap).backgroundImage);

    // Extract the image source from the background image style
    this.imageSrc = window
        .getComputedStyle(this.DOM.canvasWrap)
  ...
  render() {
    ...
    console.log(this.ctx.mozImageSmoothingEnabled);
...
const contentElems = [...document.querySelectorAll("[img-content]")];
